...
# define some other useful lists ----------
...
for (f in features) {
  ...
  ha_hyalfold <- rowAnnotation(
    ...
    hyalfold = anno_barplot(unlist(bar_hyalfold$anno_bar),
      ...
      bar_width = 0.7, gp = gpar(fill = unlist(bar_hyalfold$color))
    ),
    show_annotation_name = FALSE, width = unit(2.5, "cm")
  )
  # define the heatmap: empty matrix, only interested in the annotation
  ht_list[["hyalfold"]] <- Heatmap(matrix(nc = 0, nr = nrow(cell_line_label_colors)),
  ...
  ha_fn500colfold <- rowAnnotation(
    fn500colfold = anno_barplot(unlist(bar_fn500colfold$anno_bar),
      baseline = 0, ylim = c(-2, 2),
      axis_param = list(
        side = "bottom", labels_rot = 0,
        at = c(-2, -1.5, -1, -0.5, 0, 0.5, 1, 1.5, 2),
      ...
      bar_width = 0.7, gp = gpar(fill = unlist(bar_fn500colfold$color))
    ),
    show_annotation_name = FALSE, width = unit(2.5, "cm")
  )
  # define the heatmap: empty matrix, only interested in the annotation
  ht_list[["fn500colfold"]] <- Heatmap(matrix(nc = 0, nr = nrow(cell_line_label_colors)),
    rect_gp = gpar(type = "none"),
    show_row_dend = FALSE,
    show_column_dend = FALSE,
    ...
    row_names_side = "left",
    left_annotation = ha_fn500colfold,
    height = unit(13, "cm"),
    cluster_rows = FALSE,
    cluster_columns = FALSE
  )
  ...
  ha_fn30kcolfold <- rowAnnotation(
    fn30kcolfold = anno_barplot(unlist(bar_fn30kcolfold$anno_bar),
      baseline = 0, ylim = c(-2, 2),
      axis_param = list(
        side = "bottom", labels_rot = 0,
        at = c(-2, -1.5, -1, -0.5, 0, 0.5, 1, 1.5, 2),
      ...
      bar_width = 0.7, gp = gpar(fill = unlist(bar_fn30kcolfold$color))
    ),
    show_annotation_name = FALSE, width = unit(2.5, "cm")
  )
  # define the heatmap: empty matrix, only interested in the annotation
  ht_list[["fn30kcolfold"]] <- Heatmap(matrix(nc = 0, nr = nrow(cell_line_label_colors)),
    rect_gp = gpar(type = "none"),
    show_row_dend = FALSE,
    show_column_dend = FALSE,
    show_row_names = FALSE,
    ...
    row_names_side = "left",
    left_annotation = ha_fn30kcolfold,
    height = unit(13, "cm"),
    cluster_rows = FALSE,
    cluster_columns = FALSE
  )
  ...
  ha_ha30kcolfold <- rowAnnotation(
    ha30kcolfold = anno_barplot(unlist(bar_ha30kcolfold$anno_bar),
      baseline = 0, ylim = c(-2, 2),
      axis_param = list(
        side = "bottom",
        labels_rot = 0,
      ...
      gp = gpar(fill = unlist(bar_ha30kcolfold$color))
    ),
    show_annotation_name = FALSE, width = unit(2.5, "cm")
  )
  # define the heatmap: empty matrix, only interested in the annotation
  ht_list[["ha30kcolfold"]] <- Heatmap(matrix(nc = 0, nr = nrow(cell_line_label_colors)),
    rect_gp = gpar(type = "none"),
    show_row_dend = FALSE,
    show_column_dend = FALSE,
    show_row_names = FALSE,
    ...
    row_names_side = "left",
    left_annotation = ha_ha30kcolfold,
    height = unit(13, "cm"),
    cluster_rows = FALSE,
    cluster_columns = FALSE
  )
  ...
  ha_ha30kfnfold <- rowAnnotation(
    ha30kfnfold = anno_barplot(unlist(bar_ha30kfnfold$anno_bar),
      baseline = 0, ylim = c(-2, 2),
      axis_param = list(
        side = "bottom",
        labels_rot = 0,
      ...
      border = FALSE, bar_width = 0.7,
      gp = gpar(fill = unlist(bar_ha30kfnfold$color))
    ),
    show_annotation_name = FALSE, width = unit(2.5, "cm")
  )
  # define the heatmap: empty matrix, only interested in the annotation
  ht_list[["ha30kfnfold"]] <- Heatmap(matrix(nc = 0, nr = nrow(cell_line_label_colors)),
    rect_gp = gpar(type = "none"),
    show_row_dend = FALSE,
    show_column_dend = FALSE,
    show_row_names = FALSE,
    ...
    row_names_side = "left",
    left_annotation = ha_ha30kfnfold,
    height = unit(13, "cm"),
    cluster_rows = FALSE,
    cluster_columns = FALSE
  )
  ...
  if (f != "motility") {
    draw(ht_list[["hyalfold"]] + ha_gap + ha_gap +
      ...
      ht_list[["ha30kfnfold"]], auto_adjust = FALSE)
  } else {
  ...
  dev.off()
  keep("folds", "fold_names", "features", "feature_names", "get_color",
    "cell_line_label_colors_main",
    sure = TRUE
  )
}
