# Aim: Plots for Supplementary Figure 2 and 3 (change in physical feature with change in substrate)
...
for (f in features) {
  ...
  # 6th fold: 30kPA Coll -> Glass (glasscolfold)
  # specify the fold change based color for bar chart
  ...
  # 7th fold: 30kPa FN -> Glass (glassfnfold)
  # specify the fold change based color for bar chart
  ...
  if (f != "motility") {
    draw(
      ht_list[["hyalfold"]] + ha_gap + ha_gap +
        ht_list[["fn500colfold"]] + ha_gap + ha_gap +
        ht_list[["fn30kcolfold"]] + ha_gap + ha_gap +
        ht_list[["ha30kcolfold"]] + ha_gap + ha_gap +
        ht_list[["ha30kfnfold"]] + ha_gap + ha_gap +
        ht_list[["glasscolfold"]] + ha_gap + ha_gap + ha_gap +
        ht_list[["glassfnfold"]],
      auto_adjust = FALSE
    )
  } else {
    draw(
      ht_list[["hyalfold"]] + ha_gap + ha_gap + ha_gap +
        ht_list[["fn500colfold"]] + ha_gap + ha_gap +
        ht_list[["fn30kcolfold"]] + ha_gap + ha_gap +
        ht_list[["ha30kcolfold"]] + ha_gap + ha_gap +
        ht_list[["ha30kfnfold"]] + ha_gap + ha_gap + ha_gap + ha_gap + ha_gap +
        ht_list[["glasscolfold"]] + ha_gap + ha_gap + ha_gap +
        ht_list[["glassfnfold"]],
      auto_adjust = FALSE
    )
